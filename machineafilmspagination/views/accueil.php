<div class="container" id="3choix">
		<div class="row">
			<div class="col s12 m12 l5 xl5 choix">
				...
				<a href="http://localhost:8090/machineafilmspagination/films"><button class="btn waves-effect waves-light" type="submit" name="submit" value="send">Accéder à la liste des films</button></a>
			</div>
			...
			<div class="col s12 m12 l5 xl5 choix" >
				...
				<a href="http://localhost:8090/machineafilmspagination/inscription"><button class="btn waves-effect waves-light" type="submit" name="submit" value="send">S'inscrire</button></a>
			</div>
